...
export type MetadataDiffValue = string | number | string[] | Record<string, string> | undefined;

export interface MetadataDiffField {
  field: string;
  valueA?: MetadataDiffValue;
  valueB?: MetadataDiffValue;
  changed: boolean;
}
...
export interface CompareResult {
  ...
  versionA: string;
  versionB: string;
  metadataDiff: MetadataDiffField[];
  sizeDiff: {
    sizeA: number;
    sizeB: number;
    sizeDelta: number;
